...
public class gameManager1 : MonoBehaviour
{
  ...
  //  public float instructTimer2;
    ...
    //   public GameObject destroybuttonvis;
   ...
   // public bool ran2 = false;
    ...
    void Start()
    {
        ...
        groundCamIsOn = true;  //makes the accelerometer movement turn on in ballGyro script
        cameraTwo.enabled = true; //ground camera
       // instructTimer = 3f;
      ...
      //  Maze.transform.rotation = Quaternion.Euler(0, 0, 0);  //FOR reseting transform of scene after gyro input alters it
        groundCamIsOn = true;
    ...
    //    currentRot = ball.transform.rotation;
            ...
            //        button2destroy.gameObject.SetActive(true);
            //    }
            //    else
            //    {
            //        button.gameObject.SetActive(false);
            //        button2destroy.gameObject.SetActive(false);
            //    }
    ...
    //            buttonSpot.SetActive(true);
    //            //  destroybuttonvis.SetActive(true);

    //            if (instructTimer2 <= 0)
    //            {
    //                buttonSpot.SetActive(false);
    //                //      destroybuttonvis.SetActive(false);
