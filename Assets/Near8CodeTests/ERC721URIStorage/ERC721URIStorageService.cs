...
using Near8CodeTests.Contracts.ERC721URIStorage.ContractDefinition;

namespace Near8CodeTests.Contracts.ERC721URIStorage
{
    public partial class ERC721URIStorageService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC721URIStorageDeployment eRC721URIStorageDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721URIStorageDeployment>().SendRequestAndWaitForReceiptAsync(eRC721URIStorageDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC721URIStorageDeployment eRC721URIStorageDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721URIStorageDeployment>().SendRequestAsync(eRC721URIStorageDeployment);
        }

        public static async Task<ERC721URIStorageService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC721URIStorageDeployment eRC721URIStorageDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC721URIStorageDeployment, cancellationTokenSource);
            return new ERC721URIStorageService(web3, receipt.ContractAddress);
        }
        ...
        public ERC721URIStorageService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
